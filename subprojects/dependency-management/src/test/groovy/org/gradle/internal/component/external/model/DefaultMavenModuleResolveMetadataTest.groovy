...
class DefaultMavenModuleResolveMetadataTest extends AbstractLazyModuleComponentResolveMetadataTest {
    ...
    def "recognises java library for packaging=#packaging"() {
        ...
        variantsForGraphTraversal.size() == 7
        ...
        variantsForGraphTraversal[4].name == "platform-runtime"
        variantsForGraphTraversal[4].attributes.getAttribute(stringUsageAttribute) == "java-runtime"
        variantsForGraphTraversal[4].attributes.getAttribute(componentTypeAttribute) == "platform"
        variantsForGraphTraversal[5].name == "enforced-platform-compile"
        variantsForGraphTraversal[5].attributes.getAttribute(stringUsageAttribute) == "java-api"
        variantsForGraphTraversal[6].attributes.getAttribute(componentTypeAttribute) == "enforced-platform"
        variantsForGraphTraversal[6].name == "enforced-platform-runtime"
        variantsForGraphTraversal[6].attributes.getAttribute(stringUsageAttribute) == "java-runtime"
        variantsForGraphTraversal[6].attributes.getAttribute(componentTypeAttribute) == "enforced-platform"
