...
class DefaultPropertyWalkerTest extends AbstractProjectBuilderSpec {
    ...
    def "visits properties"() {
        ...
        1 * visitor.visitInputFileProperty('inputFile', _, _, _, _, _, _, _, _, InputFilePropertyType.FILE)
        1 * visitor.visitInputFileProperty('inputFiles', _, _, _, _, _, _, _, _, InputFilePropertyType.FILES)
        ...
        1 * visitor.visitInputFileProperty('bean.inputDir', _, _, _, _, _, _, _, _, InputFilePropertyType.DIRECTORY)
    ...
    def "providers are unpacked"() {
        ...
        1 * visitor.visitInputFileProperty("nested.inputDir", _, _, _, _, _, _, _, _, InputFilePropertyType.DIRECTORY)
