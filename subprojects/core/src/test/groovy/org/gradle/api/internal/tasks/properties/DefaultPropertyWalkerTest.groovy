...
class DefaultPropertyWalkerTest extends AbstractProjectBuilderSpec {
    ...
    def "visits properties"() {
        ...
        1 * visitor.visitInputFileProperty('inputFiles', _, false, _, _, _, _, _, _, InputFilePropertyType.FILES)
        ...
        1 * visitor.visitInputFileProperty('bean.inputDir', _, false, _, _, _, _, _, _, InputFilePropertyType.DIRECTORY)
