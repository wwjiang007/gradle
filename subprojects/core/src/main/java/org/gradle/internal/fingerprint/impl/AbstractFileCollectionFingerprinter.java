...
public abstract class AbstractFileCollectionFingerprinter implements FileCollectionFingerprinter {
    ...
    public CurrentFileCollectionFingerprint fingerprint(FileCollection files, @Nullable FileCollectionFingerprint previousFingerprint) {
        ...
        return DefaultCurrentFileCollectionFingerprint.from(snapshotResult.getSnapshot(), snapshotResult.isOnlyFileTrees(), fingerprintingStrategy, previousFingerprint);
    }
